...
impute_fn_knn_all <- function(x_missing, x_complete, k, q, sigma, verbose) {
    .Call('imputation_impute_fn_knn_all', PACKAGE = 'imputation', x_missing, x_complete, k, q, sigma, verbose)
}
